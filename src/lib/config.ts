...
export const BUSINESS_CONFIG = {
  ...
  phone: "+91-XXXXXXXXXX", // UPDATE: Replace with real phone number
  whatsapp: "91XXXXXXXXXX", // UPDATE: Replace with real WhatsApp number (no + or spaces)
  address: "Your City, Maharashtra, India", // UPDATE: Replace with real address
  googleMapsLink: "https://maps.google.com", // UPDATE: Replace with real Google Maps link
  email: "mugdhacaterers@email.com", // UPDATE
  instagram: "https://instagram.com/mugdhacaterers", // UPDATE
  facebook: "https://facebook.com/mugdhacaterers", // UPDATE
...
export const SPECIAL_THALI = {
  ...
  image:
    "https://img.rocket.new/generatedImages/rocket_gen_img_1e4e6e9d2-1772194107998.png",
  items: [
    ...
    { category: "Sweet", items: ["Gulab Jamun / Jalebi"] },
    {
      ...
      items: [
        "Fresh Garden Salad",
        "Roasted Papad",
        "Traditional Indian Pickle (Achar)",
      ],
    },
  ],
};
...
export const LIVE_COUNTERS = [
  ...
  },
  {
    ...
    icon: "🍬",
    image:
      "https://img.rocket.new/generatedImages/rocket_gen_img_18e5d8cb2-1765647822141.png",
...
export const SERVICES = [
  {
    ...
    icon: "💍",
    image:
      "https://img.rocket.new/generatedImages/rocket_gen_img_1f8ea1cf2-1772090160203.png",
    description:
      "Make your big day unforgettable with our elegant wedding catering",
  },
  {
    id: "birthday",
    ...
    icon: "🎂",
    image:
      "https://img.rocket.new/generatedImages/rocket_gen_img_15c3d4833-1787514241618.png",
  ...
  },
  {
    ...
    icon: "🏢",
    image:
      "https://img.rocket.new/generatedImages/rocket_gen_img_1be6aae75-1787514242377.png",
    description:
      "Professional catering for meetings, launches, and office events",
  },
  {
    id: "house-party",
    name: "House Parties",
    icon: "🏠",
    image:
      "https://img.rocket.new/generatedImages/rocket_gen_img_1f2500993-1787514241842.png",
    description:
      "Intimate home gatherings made special with fresh home-style food",
  },
  {
    id: "religious",
    ...
    icon: "🙏",
    image:
      "https://img.rocket.new/generatedImages/rocket_gen_img_15f81ee93-1787514240532.png",
  ...
  },
  {
    ...
    icon: "📦",
    image:
      "https://img.rocket.new/generatedImages/rocket_gen_img_15ce0c563-1787514240356.png",
...
export const GALLERY_IMAGES = [
  {
    ...
    caption: "Traditional Thali",
  },
  {
    id: 2,
    src: "https://img.rocket.new/generatedImages/rocket_gen_img_13f210125-1773114061256.png",
  ...
  {
    id: 3,
    src: "https://img.rocket.new/generatedImages/rocket_gen_img_16140b6f5-1785162844112.png",
    alt: "Chef preparing fresh dosas on a large tawa at a live counter, steam rising, evening event lighting",
    caption: "Live Dosa Counter",
  },
  {
    id: 4,
  ...
  {
    id: 9,
    src: "https://img.rocket.new/generatedImages/rocket_gen_img_1e8aa6cce-1766536089828.png",
    alt: "Kulcha with chole being served at a live counter, steam visible, warm event lighting",
    caption: "Kulcha Chole Counter",
  },
  {
    id: 10,
    src: "https://images.unsplash.com/photo-1694278020220-5fc96238b28f",
    alt: "Fresh jalebis being fried in oil at a live counter, golden orange color, dark background",
    caption: "Jalebi Counter",
  },
];
...
export const REVIEWS = [
  {
    ...
    avatar:
      "https://img.rocket.new/generatedImages/rocket_gen_img_140f404c7-1768465100399.png",
  },
  {
    id: 2,
    name: "Rahul Deshmukh",
    ...
    avatar:
      "https://img.rocket.new/generatedImages/rocket_gen_img_1420b3ba9-1768465099830.png",
  },
  {
    id: 3,
    name: "Sunita Patil",
    ...
    avatar:
      "https://img.rocket.new/generatedImages/rocket_gen_img_10481e6ba-1772259856514.png",
  },
  {
    id: 4,
    name: "Amit Kulkarni",
    ...
    avatar:
      "https://img.rocket.new/generatedImages/rocket_gen_img_1189a4555-1779957341953.png",
  },
];
